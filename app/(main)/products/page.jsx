            ...
            <div className="container-custom">
                ...
                <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
                    {filteredProducts.map((product, index) => {
                        // Use custom 'id' if available, fallback to '_id'
                ...
                >
                    {[
                        ...
                        { icon: '⭐', label: 'Avg Rating', value: (products.reduce((sum, p) => sum + p.rating, 0) / products.length || 0).toFixed(1) },
